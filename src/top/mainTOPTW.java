...
public class mainTOPTW {
     ...
     * @details El método principal del programa se encarga de leer los ficheros
     * de instancias, crear los objetos necesarios para resolver el problema y
     * ejecutar el algoritmo GRASP con los parámetros indicados.
     */
