...
/**
 * @brief Clase que implementa el algoritmo GRASP para el problema TOPTW.
 * @details Esta clase implementa el algoritmo GRASP para el problema TOPTW.
 * El algoritmo GRASP se basa en la construcción de una solución inicial mediante 
 * una heurística greedy aleatorizada y posteriormente se aplica una búsqueda local
 * para mejorar la solución. El algoritmo se ejecuta un número determinado de veces
 * y se devuelve la mejor solución encontrada.
 */
public class TOPTWGRASP {
 public static double NO_EVALUATED = -1.0;
    ...
    /**
     * @brief Selección aleatoria de un elemento de la lista restringida de candidatos.
     * @param maxTRCL
     * @return Devuelve la posición del elemento seleccionado de la lista restringida de candidatos.
     */
    ...
    /**
     * @brief Selección del mejor elemento de la lista restringida de candidatos.
     * @param rcl
     * @return Devuelve la posición del elemento seleccionado de la lista restringida de candidatos.
     */
    ...
    /**
     * @brief Construcción de la solución inicial mediante una heurística greedy aleatorizada.
     * @param maxSizeRCL
